				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?= BASE_URL; ?>lang/set/es">Espanhol</a></li>
						</ul>
					</li>
						...
						<li class="dropdown">
					        ...
					        <ul class="dropdown-menu">
					          <?php
					          	...
					          	<li>
					          		<a href="<?= BASE_URL.'categories/enter/'.$cat['id']; ?>"><?= $cat['name']; ?></a>
					          	</li>
					          <?php
					          	if (count($cat['subs']) > 0) {
					      ...
					      <?php
					      	if (isset($viewData['category_filter'])): ?>
				  	...
				  	<aside>
				  		...
				  		<div class="filterarea">
				  			...
				  			<div class="filterbox">
				  				...
				  				<div class="filtercontent">
				  					<?php 
				  						foreach ($viewData['filters']['options'] as $option): ?>
				  						<strong><?= $option['name'] ?></strong></br>
				  						<?php
				  							foreach ($option['options'] as $op): ?>
					  							<div class="filteritem">
					  								<input type="checkbox" name="filter[options][]" value="<?= $op['id']; ?>" id="filter_options<?= $op['id']; ?>" />
					  								<label for="filter_options<?= $op['id']; ?>">
					  									<?= $op['value']; ?>
					  								</label>
					  								<span style="float:right;">
					  									(<?= $op['count']; ?>)
